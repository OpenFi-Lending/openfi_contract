...
interface IPoolConfigurator {
   ...
   * @param input The bToken update parameters
   */
  function updateBToken(ConfiguratorInputTypes.UpdateBTokenInput calldata input) external;
   ...
   * swap interest rate, liquidate, btoken transfers).
   * @param asset The address of the underlying asset of the reserve
   ...
   * - A part is sent to btoken holders as extra balance
